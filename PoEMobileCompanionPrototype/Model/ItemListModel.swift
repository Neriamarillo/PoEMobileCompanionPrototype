...
struct ItemListModel {
    static let itemTypes: [String] = ["Currency", "Fragment", "DeliriumOrb", "Watchstone", "Oil",
    ...
    static let itemTypeStrings: [String] = ["Currency", "Fragments", "Delirium Orbs", "Watchstones", "Oils",
